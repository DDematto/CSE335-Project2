 ...
 */
void Machine1Factory::TopBeamAndRamp(std::shared_ptr<MachineActual> machine)
{
 ...
 */
void Machine1Factory::DominoStack(std::shared_ptr<MachineActual> machine, wxPoint2DDouble position)
{
 ...
 * @param machine Machine to add to
 */
void Machine1Factory::BeamAndSpinningArm(std::shared_ptr<MachineActual> machine)
{
 ...
 * @param machine Machine to add to
 */
void Machine1Factory::BasketballGoal(std::shared_ptr<MachineActual> machine)
{
 ...
 */
void Machine1Factory::DominoesOnBeam(std::shared_ptr<MachineActual> machine, wxPoint2DDouble position)
{
 ...
 */
std::shared_ptr<Body> Machine1Factory::Domino(std::shared_ptr<MachineActual> machine,
